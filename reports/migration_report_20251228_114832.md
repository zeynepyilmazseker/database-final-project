...
**Oluşturulma Tarihi:** 2025-12-28 11:48:32
...
1. categories tablosu aktarım hatası: tuple indices must be integers or slices, not str
2. order_items tablosu aktarım hatası: tuple indices must be integers or slices, not str
3. orders tablosu aktarım hatası: tuple indices must be integers or slices, not str
4. payments tablosu aktarım hatası: tuple indices must be integers or slices, not str
5. products tablosu aktarım hatası: tuple indices must be integers or slices, not str
6. users tablosu aktarım hatası: tuple indices must be integers or slices, not str
