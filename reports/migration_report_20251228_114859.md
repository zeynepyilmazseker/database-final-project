...
**Oluşturulma Tarihi:** 2025-12-28 11:48:59
...
1. categories tablosu aktarım hatası: Collection objects do not implement truth value testing or bool(). Please compare with None instead: collection is not None
2. order_items tablosu aktarım hatası: Collection objects do not implement truth value testing or bool(). Please compare with None instead: collection is not None
3. orders tablosu aktarım hatası: Collection objects do not implement truth value testing or bool(). Please compare with None instead: collection is not None
4. payments tablosu aktarım hatası: Collection objects do not implement truth value testing or bool(). Please compare with None instead: collection is not None
5. products tablosu aktarım hatası: Collection objects do not implement truth value testing or bool(). Please compare with None instead: collection is not None
6. users tablosu aktarım hatası: Collection objects do not implement truth value testing or bool(). Please compare with None instead: collection is not None
